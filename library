local function initLibrary()
    ...
    do -- library funcs
        ...
        local ui_Settings = {
            ...
            scrollingBarColor = Color3.fromRGB(227, 35, 68);
            toggleColor = Color3.fromRGB(34, 34, 34);
            toggleBorderColor = Color3.fromRGB(227, 35, 68);
            boxColor = Color3.fromRGB(32, 32, 32);
            boxBorderColor = Color3.fromRGB(227, 35, 68);
            gradientColorSection = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(227, 35, 68)), ColorSequenceKeypoint.new(1, Color3.fromRGB(227, 35, 68))};
            gradientColor = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(227, 35, 68)), ColorSequenceKeypoint.new(0, Color3.fromRGB(227, 35, 68)), ColorSequenceKeypoint.new(1, Color3.fromRGB(210, 74, 255))};
            ...
            library:Create("ImageLabel", {
                ...
                library:Create("ImageLabel", {
                    ...
                    library:Create("UIGradient", {
                        Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(227, 35, 68)), ColorSequenceKeypoint.new(1, Color3.fromRGB(26, 26, 39))};
                        Rotation = 45;
                    });
                });
            });
            ...
            library:Create("Frame", {
                ...
                library:Create("Frame", {
                    ...
                    library:Create("TextLabel", {
                        ...
                        TextSize = 14;
                        library:Create("UIGradient", {
                            Color = ColorSequence.new{ColorSequenceKeypoint.new(0, Color3.fromRGB(227,35,68)), ColorSequenceKeypoint.new(1, Color3.fromRGB(227,35,68))}
                        });
                    });
                    library:Create("Frame", {
                        Name = "topcontainer";
        ...
        function library:CreateSection(name)
            ...
            function section:Slider(sliderName, properties, callback)
                ...
                local holder = library:Create("Frame", {
                    ...
                    library:Create("TextButton", {
                        Name = "slider";
                        BackgroundColor3 = Color3.fromRGB(34, 34, 34);
                        BorderColor3 = Color3.fromRGB(227, 35, 68);
            ...
            function section:Dropdown(name, list, callback)
                ...
                local holder = library:Create("Frame", {
                    ...
                    library:Create("TextButton", {
                        Name = "dropdown";
                        BackgroundColor3 = Color3.fromRGB(227, 35, 68);
                        BorderColor3 = Color3.fromRGB(227, 35, 68);
                        Size = UDim2.new(1, 0, 0, 18);
                        AutoButtonColor = false;
                        Font = "SourceSans";
            ...
            function section:ColorPicker(pickerName, defaultColor, callback)
                local callback = callback or function() end;
                local defaultColor = defaultColor or Color3.fromRGB(227, 35, 68);
